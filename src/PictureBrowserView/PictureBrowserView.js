...
export default class PictureBrowserView extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.currentTapIndex > currentTapIndex) {
            this.setState({
                  ...
                  <View>
                      ...
                      >
                          <PhotoZoomView
                              ...
                              sourceImg={sourceImg}
                              photoDefaultImg={browserDefaultImg}
  ...
  alterSaveView = () => {
      const { browserKey, browserData, onSaveCallback } = this.props;
              ...
              >
                  ...
                  >
                      <View style={styles.textViewStyle}>
                          <Text style={styles.titleStyle}>{`${imageArrs[currentPage - 1][browserNameKey]}`}</Text>
                      </View>
                      <ScrollView
              ...
              >
                  <View style={styles.textViewStyle}>
                      <Text style={styles.titleStyle}>
                          {`${imageArrs[currentPage - 1][browserNameKey] === undefined ? '' : imageArrs[currentPage - 1][browserNameKey]}`}
                      </Text>
                  </View>
                  <ViewPagerAndroid
